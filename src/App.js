...
// Preparation Schedule Component
function PreparationSchedule({ week, subject }) {
  // Sample curriculum distribution for 20 weeks of Mathematics
  const mathsWeeklyPlan = {
    0: { topic: 'Module 1: Functions & Relations', subtopic: 'Set theory, Relations, Functions', days: ['Sets & Relations', 'Functions', 'Composite Functions', 'Inverse Functions', 'Binary Operations', 'Review & Practice'] },
    1: { topic: 'Module 2: Complex Numbers', subtopic: 'Introduction to Complex Numbers', days: ['Complex Number Basics', 'Algebra of Complex Numbers', 'Modulus & Argument', 'De Moivre\'s Theorem', 'Roots of Complex', 'Weekly Test'] },
    2: { topic: 'Module 3: Quadratic Functions & Equations', subtopic: 'Quadratic Functions and Equations', days: ['Quadratic Basics', 'Nature of Roots', 'Graphs & Inequalities', 'Max/Min Values', 'Applications', 'Review & Test'] },
    3: { topic: 'Module 4: Progressions', subtopic: 'AP, GP, HP', days: ['Arithmetic Progression', 'Geometric Progression', 'Harmonic Progression', 'Sum Formulas', 'Applications', 'Practice & Test'] },
    4: { topic: 'Module 5: Permutations & Combinations', subtopic: 'P & C Fundamentals', days: ['Factorials', 'Permutations', 'Combinations', 'Circular Arrangements', 'Counting Principles', 'Review & Test'] },
    5: { topic: 'Module 6: Binomial Theorem', subtopic: 'Expansion & Applications', days: ['Binomial Expansion', 'General & Middle Terms', 'Binomial Coefficients', 'Special Cases', 'Applications', 'Practice & Test'] },
    6: { topic: 'Module 7: Trigonometry (Part 1)', subtopic: 'Trigonometric Ratios', days: ['Trig Ratios', 'Unit Circle', 'Identities Intro', 'Compound Angles', 'Multiple Angles', 'Weekly Test'] },
    7: { topic: 'Module 7: Trigonometry (Part 2)', subtopic: 'Trigonometric Equations', days: ['Trig Equations', 'Inverse Trig Functions', 'Heights & Distances', 'Hyperbolic Functions', 'Applications', 'Review & Test'] },
    8: { topic: 'Module 8: Coordinate Geometry (Part 1)', subtopic: 'Straight Lines', days: ['Distance & Section', 'Straight Line Basics', 'Slopes & Angles', 'Line Forms', 'Pair of Lines', 'Weekly Test'] },
    9: { topic: 'Module 8: Coordinate Geometry (Part 2)', subtopic: 'Circles & Conics', days: ['Circle Equation', 'Tangent & Normal', 'Parabola', 'Ellipse', 'Hyperbola', 'Practice & Test'] },
    10: { topic: 'Module 9: 3D Geometry', subtopic: 'Space Coordinates', days: ['Coordinate System', 'Direction Cosines', 'Lines in Space', 'Planes', 'Distances & Angles', 'Weekly Test'] },
    11: { topic: 'Module 10: Vectors', subtopic: 'Vector Algebra', days: ['Vector Basics', 'Scalar Product', 'Vector Product', 'Triple Products', 'Applications', 'Review & Test'] },
    12: { topic: 'Module 11: Limits & Continuity', subtopic: 'Fundamentals of Calculus', days: ['Limit Basics', 'Continuity', 'Differentiability', 'L\'Hôpital Rule', 'Advanced Problems', 'Weekly Test'] },
    13: { topic: 'Module 12: Derivatives (Part 1)', subtopic: 'Differentiation Techniques', days: ['Power Rule', 'Chain Rule', 'Product & Quotient', 'Implicit Diff', 'Logarithmic Diff', 'Practice & Test'] },
    14: { topic: 'Module 12: Derivatives (Part 2)', subtopic: 'Applications of Derivatives', days: ['Monotonicity', 'Extrema', 'Concavity', 'Optimization', 'Tangents & Normals', 'Weekly Test'] },
    15: { topic: 'Module 13: Integration', subtopic: 'Indefinite & Definite Integration', days: ['Antiderivatives', 'Substitution', 'Integration by Parts', 'Partial Fractions', 'Definite Integration', 'Review & Test'] },
    16: { topic: 'Module 14: Applications of Integration', subtopic: 'Area & Volume', days: ['Area Under Curves', 'Area Between', 'Volume of Solids', 'Arc Length', 'Surface Area', 'Weekly Test'] },
    17: { topic: 'Module 15: Differential Equations', subtopic: 'DE Solutions', days: ['Order & Degree', 'Variable Separable', 'Homogeneous Equations', 'Linear Equations', 'Applications', 'Practice & Test'] },
    18: { topic: 'Module 16: Probability & Statistics', subtopic: 'Probability Theory', days: ['Probability Basics', 'Conditional Prob', 'Bayes Theorem', 'Distributions', 'Statistics', 'Review & Test'] },
    19: { topic: 'Final Revision & Tests', subtopic: 'Complete Coverage Review', days: ['Module Tests 1-4', 'Module Tests 5-8', 'Module Tests 9-12', 'Module Tests 13-16', 'Mock Exam', 'Final Assessment'] }
  };

  const weekPlan = mathsWeeklyPlan[week] || mathsWeeklyPlan[0];
  const days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday & Sunday'];
  const studyHours = [6, 6, 6, 6, 6, 5];
  const testType = ['Study & Notes', 'Study & Notes', 'Study & Notes', 'Study & Notes', 'Study & Notes', 'Test Review'];

  return (
    <div>
      <div style={{ marginBottom: '24px', padding: '16px', backgroundColor: '#f0f9ff', borderRadius: 'var(--radius)', borderLeft: '4px solid #3b82f6' }}>
        <h3 style={{ color: '#1e40af', marginTop: 0 }}>{weekPlan.topic}</h3>
        <p style={{ color: 'var(--muted)', marginBottom: 0 }}>{weekPlan.subtopic}</p>
      </div>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table style={{
          ...
          <thead>
            <tr style={{ backgroundColor: '#f3f4f6', borderBottom: '3px solid #3b82f6' }}>
              <th style={{
                padding: '12px',
                textAlign: 'left',
                fontWeight: '600',
              ...
              <tr key={idx} style={{
                ...
                <td style={{
                  ...
                  <span style={{
                    ...
                    padding: '4px 12px',
                    backgroundColor: idx < 5 ? '#dbeafe' : '#d1fae5',
                    color: idx < 5 ? '#1e40af' : '#065f46',
                    borderRadius: '4px',
                    fontSize: '0.85em',
                    fontWeight: '600'
                  }}>
      ...
      <div style={{ padding: '16px', backgroundColor: '#f3f4f6', borderRadius: 'var(--radius)', marginTop: '20px' }}>
        <h4 style={{ marginTop: 0, color: '#374151' }}>📝 Daily Test Format</h4>
        <ul style={{ color: 'var(--muted)', lineHeight: '1.8' }}>
          <li><strong>Monday-Friday:</strong> 1 hour quick quiz on the day's topic (15-20 questions, MCQ + short answers)</li>
          <li><strong>Saturday-Sunday:</strong> Comprehensive weekly test covering all topics of the week (50+ questions, mixed format)</li>
          <li><strong>Performance Tracking:</strong> Keep track of accuracy % and weak areas for revision</li>
        </ul>
      </div>
    </div>
  );
...
function App() {
  ...
  const [expandedSyllabusTopics, setExpandedSyllabusTopics] = useState({});
  const [syllabusBoardSubject, setSyllabusBoardSubject] = useState({ board: 'inter1', subject: 'physics' });
  const [syllabusSubtabs, setSyllabusSubtabs] = useState({ inter1: {}, inter2: {}, eapcet: {}, jee: {} });
